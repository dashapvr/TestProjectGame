...
class LevelTwoScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let levelLabel = SKSpriteNode(imageNamed: "lvlTwoLabel")
        ...
        let patternImage = SKSpriteNode(imageNamed: "lvlTwoImage")
    ...
    func createPuzzle() {
        var count: Int = 0
        let image = UIImage(named: "lvlTwoImage")?.resizeimage(imagesize: (self.view?.frame.width)!, row: CGFloat(row), col: CGFloat(col))
